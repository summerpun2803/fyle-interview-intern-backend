...
class Assignment(db.Model):
    ...
    def mark_grade(cls, _id, grade, auth_principal: AuthPrincipal):
        ...
        assertions.assert_valid(assignment.teacher_id == auth_principal.teacher_id , 'Cannot be graded by different teacher')
    ...
    def update_grade(cls,_id,grade):
        ...
        assertions.assert_valid(assignment.state is not AssignmentStateEnum.DRAFT,'Assignment is in Draft state')
